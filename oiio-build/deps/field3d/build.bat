...
set LIB_DIR=Field3D-1.7.3
set LIB_PATH=%cd%


set BOOST_PATH=%USERPROFILE%\Documents\boost\boost_src
set HDF5_PATH=%USERPROFILE%\Documents\OIIO\deps\hdf5\%ARCH%
REM - TODO: problem with OpenEXR/IlmBase/Imath
REM set ILMBASE_PATH=%USERPROFILE%\Documents\OIIO\deps\openexr\%ARCH%\%BUILD_TYPE%
...
exit /b
 ...
 REM -DILMBASE_ROOT= "%ILMBASE_PATH%" ^
